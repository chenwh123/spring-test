 ...
 */
@Slf4j
public class BaseController<T extends ServiceImpl<M , O>,M extends BaseMapper<O>, O> {
     ...
     * column : param_name
     */
    public static Map<String, String> getTableFieldMap(Class<?> cClass) {
     ...
     */
    public static String dealCondition(String condition, Class<?> cClass) {
        //获取所有属性名和列名的映射关系
    ...
    public R search(SearchVo searchVo) {
        ...
        return R.data(this.service.page(page, queryWrapper));
